...
const monthlyReportSchema = z.object({
  ...
  soloPersonalSpendMinorUnits: z.number().int(),
  sharedSpendTotalMinorUnits: z.number().int(),
  sharedSpendMyShareMinorUnits: z.number().int(),
  sharedSpendOtherShareMinorUnits: z.number().int(),
  partnerSpendMinorUnits: z.number().int(),
